...
public class TestWorkloadApiClient
{
    ...
    {
        using X509Certificate2 cert = CertUtil.FirstFromPemFile("TestData/X509/good-leaf-only.pem");
    ...
    public async Task TestWatchX509Bundles()
    {
        ...
        using X509Certificate2 first = CertUtil.FirstFromPemFile("TestData/X509/good-leaf-only.pem");

        TrustDomain secondTrustDomain = TrustDomain.FromString("spiffe://example2.org");
        using X509Certificate2 second = CertUtil.FirstFromPemFile("TestData/X509/good-leaf-and-intermediate.pem");
    ...
    public async Task TestFetchX509Context()
    {
        ...
        var hint = "internal";
        using X509Certificate2 bundleCert = CertUtil.FirstFromPemFile("TestData/X509/good-leaf-and-intermediate.pem");
    ...
    public async Task TestWatchX509Context()
    {
        ...
        X509Certificate2 federatedCert = CertUtil.FirstFromPemFile("TestData/X509/good-leaf-and-intermediate.pem");
