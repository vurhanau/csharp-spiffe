...
using GrpcChannel channel = GrpcChannel.ForAddress("https://localhost:6000", new GrpcChannelOptions()
{
    HttpHandler = new SpiffeHttpHandler(x509Source, Authorizers.AuthorizeAny()),
